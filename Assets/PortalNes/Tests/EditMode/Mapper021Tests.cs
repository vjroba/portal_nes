...
{
    public sealed class Mapper021Tests
    {
        [Test]
        public void UsesVrc4aA1A2AddressLines()
        {
            var mapper = CreateMapper();
            // Slot 0 low/high are x000/x002; slot 1 low/high are x004/x006.
            mapper.CpuWrite(0xB000, 3);
            mapper.CpuWrite(0xB002, 0);
            mapper.CpuWrite(0xB004, 4);
            mapper.CpuWrite(0xB006, 0);
        ...
        [Test]
        public void UsesVrc4cA6A7AddressLines()
        {
            var mapper = CreateMapper();
            // Slot 0 low/high are x000/x040; slot 1 low/high are x080/x0C0.
            mapper.CpuWrite(0xB000, 5);
            mapper.CpuWrite(0xB040, 0);
            mapper.CpuWrite(0xB080, 6);
            mapper.CpuWrite(0xB0C0, 0);
        ...
        [Test]
        public void DecodesControlAndIrqThroughVrc4aWiring()
        {
            var mapper = CreateMapper();
            mapper.CpuWrite(0x8000, 2);
            mapper.CpuWrite(0x9004, 2);
            ...
            mapper.CpuWrite(0xF004, 0x07);
            mapper.ClockCpu(2);
            Assert.That(mapper.IrqPending, Is.True);
            mapper.CpuWrite(0xF006, 0);
            Assert.That(mapper.IrqPending, Is.False);
        }

        private static Mapper021 CreateMapper()
        {
            ...
            return new Mapper021(prg, chr, MirroringMode.Horizontal);
        }
    }
}
