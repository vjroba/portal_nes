...
The commercial **Portalgraph SDK is not included in this repository**. Install
the free Portalgraph Runtime before opening or building the Portalgraph scenes:
...
Portalgraph用シーンを開く・ビルドする前に、無料のPortalgraph Runtimeを
インストールしてください。
